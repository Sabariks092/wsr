...
const Platforms = () => {
  return (
    <div className='flex justify-center gap-3 items-center lg:my-4'>
        ...
        <a href="https://open.spotify.com/show/3Vyzr177KDIGxUPjEHzfMD"><Image src={spotify} alt="Spotify"  className=' w-8 h-8 md:w-12 md:h-12shadow-[0_2px_8px_rgba(0,0,0,0.5)] hover:scale-110 transition-all duration-200'/></a>
        <a href="https://castbox.fm/channel/Wild-South-Raiders-Podcast-id6713477?country=gb"><Image src={cloudsound} alt="Google Podcasts"  className=' w-8 h-8 md:w-12 md:h-12shadow-[0_2px_8px_rgba(0,0,0,0.5)] hover:scale-110 transition-all duration-200'/></a>
        <a href="https://pocketcasts.com/podcast/wild-south-raiders-podcast/045459f0-5a2d-013e-fb5b-0affd256cbb1"><Image src={pocketcasts} alt="Pocket Casts" className=' w-8 h-8 md:w-12 md:h-12shadow-[0_2px_8px_rgba(0,0,0,0.5)] hover:scale-110 transition-all duration-200'/></a>
    </div>
  )
}
